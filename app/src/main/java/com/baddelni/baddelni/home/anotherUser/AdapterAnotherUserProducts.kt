...
class AdapterAnotherUserProducts(val context: Context, val list: MutableList<pojoAccountHome>) : RecyclerView.Adapter<AdapterAnotherUserProducts.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, postion: Int) {
        ...
        viewHolder.binding.saveBt.visibility = View.VISIBLE
        viewHolder.binding.shareBt.visibility = View.VISIBLE
        viewHolder.binding.menuBt.visibility = View.INVISIBLE
        ...
        private fun setPopUpWindow(viewHolder: ViewHolder) {
            ...
            /*  save.setOnClickListener {
              ...
              delete.setOnClickListener {
                  co.DeleteProduct(list[viewHolder.adapterPosition].pId.toString(), this@AdapterAnotherUserProducts, viewHolder.adapterPosition, list)
                  mypopupWindow.dismiss()
              }
              republish.setOnClickListener {
                  co.RePublishProduct(list[viewHolder.adapterPosition].pId.toString(), this@AdapterAnotherUserProducts, viewHolder.adapterPosition, list)
                  mypopupWindow.dismiss()
              }
