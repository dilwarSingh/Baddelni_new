...
import com.baddelni.baddelni.Response.home.InterestedProductsItem
...
class TopIntrestAdapter(val context: Context, val list: List<InterestedProductsItem>) : RecyclerView.Adapter<TopIntrestAdapter.viewHolder>() {
