...
class CreatePostActivity : AppCompatActivity() {
    ...
    var binding: ActivityCreatePostNewBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_create_post_new)
        getCategoriesData()
    ...
    private fun getCountyData() {
        ...
        Api.getApi().getCountries(co.getAppLanguage().langCode()).enqueue(object : Callback<Countries> {
            ...
            override fun onResponse(call: Call<Countries>, response: Response<Countries>) {
                ...
                body?.apply {
                    if (code!!.isSuccess()) {
                        this@CreatePostActivity.countryList = countryList!!
            ...
            override fun onResponse(call: Call<Category>, response: Response<Category>) {
                ...
                body?.apply {
                    if (code!!.isSuccess()) {
                        ...
                        this@CreatePostActivity.categoryList = categories
                        getCountyData()
